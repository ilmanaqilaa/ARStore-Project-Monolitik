        ...
        <div class="col">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    No. Rekening 012345-678-910 atas nama <strong>Muhammad Ilman Aqilaa</strong>
                </div>
            </div>
        </div>
        <div class="col">
            ...
            <form wire:submit.prevent="checkout">
                ...
                <div class="form-group" enctype="multipart/form-data">
                    ...
                    <input id="bkt_transaksi" type="file"  class="form-control @error('bkt_transaksi') is-invalid @enderror" wire:model="bkt_transaksi"
