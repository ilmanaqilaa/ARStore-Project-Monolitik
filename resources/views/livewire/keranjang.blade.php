                ...
                <table class="table text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $no++ }}</td>
                            <td>
                                <img src="{{ url('assets/g_produk') }}/{{ $pesanan_detail->product->gambar }}" class="img-fluid" width="200">
                            </td>
                            <td>
                            ...
                            <td>
                                <i wire:click="destroy({{ $pesanan_detail->id }})" class="fas fa-trash text-danger btn btn-danger "></i>
                            </td>
                        </tr>    
                        @empty
                        <tr>
