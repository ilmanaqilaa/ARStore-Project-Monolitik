            ...
            <div class="col-md-3 mb-3 d-flex">
                <div class="card">
                    <div class="card-body text-center">
                        <img src="{{ url('assets/g_produk') }}/{{ $product->gambar }}" class="card-img-top">
                        <div class="row mt-4">
                            <div class="col-md-12">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <a href="{{ route('products.detail', $product->id) }}" class="btn btn-dark btn-block"><i class="fas"></i> Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
